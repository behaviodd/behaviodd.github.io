...
K-POP Digging Club은 K-POP 청취자가 익숙한 취향의 벽을 넘어 새로운 음악을 발견할 수 있도록 돕는 웹 기반 음악 추천 서비스입니다. Spotify 트랙 링크를 입력하면, 해당 곡의 음악적 특성(태그, 템포, 청취 패턴)을 분석하여 **K-POP을 제외한** 전 세계 유사 곡을 최대 30곡까지 추천합니다.
